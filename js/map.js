...
var showSimilarAdInfo = function (similarAdCard) {
  similarAdCard.classList.remove('hidden');
  mapWindow.insertBefore(similarAdCard, mapFiltersBlock);
};
